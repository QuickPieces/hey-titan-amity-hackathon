...
declare global {
    namespace Amity {
        ...
        type ChannelMemberActionType = 'onJoin' | 'onLeft' | 'onMemberRead' | 'onMemberAdded' | 'onMemberRemoved' | 'onChannelMemberBanned' | 'onChannelMemberUnbanned';
        type ChannelActionType = 'onFetch' | 'onCreate' | 'onUpdate' | 'onDelete' | 'onJoin' | 'onLeft' | 'onMute' | 'onMemberAdded' | 'onMemberRemoved';
        ...
        type RawChannel<T extends ChannelType = any> = Omit<Channel<T>, 'defaultSubChannelId' | 'defaultSubChannelUnreadCount' | 'defaultSubChannelHasUnreadMention' | 'localReadToSegment' | 'localLastMentionSegment'> & {
            _id: string;
        };
        type QueryChannels = {
            displayName?: string;
